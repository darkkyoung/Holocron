...
export const SEASON_CATALOG:SeasonCatalogEntry[]=[
  ...
  {seriesKey:'ahsoka',seasonNumber:1,title:'아소카 시즌 1',originalTitle:'Ahsoka Season 1',type:'드라마',status:'archive',releaseDate:'2023-08-22',releasePrecision:'day',posterUrl:'https://lumiere-a.akamaihd.net/v1/images/ahsoka-poster-post-catalog_3617795e.jpeg',posterSource:'manual-official',posterReferenceUrl:official('ahsoka'),fallbackPosterUrl:'https://lumiere-a.akamaihd.net/v1/images/ahsoka-poster-post-catalog_3617795e.jpeg',officialUrl:official('ahsoka')},
